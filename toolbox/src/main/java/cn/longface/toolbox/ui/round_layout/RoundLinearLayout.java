...
public class RoundLinearLayout extends LinearLayout{
    ...
    public RoundLinearLayout setLeftTopRound(float leftTopRound) {
    ...
    public RoundLinearLayout setRightTopRound(float rightTopRound) {
    ...
    public RoundLinearLayout setLeftBottomRound(float leftBottomRound) {
    ...
    public RoundLinearLayout setRightBottomRound(float rightBottomRound) {
